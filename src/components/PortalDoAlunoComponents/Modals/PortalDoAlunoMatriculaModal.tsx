...
import { Eye, GraduationCap, Plus, X } from 'lucide-react';
import { Link } from 'react-router-dom';

export const PortalDoAlunoMatriculaModal = ({ item }: any) => {
  return (
    <Dialog key={item.key}>
      ...
      >
        ...
        <DialogHeader className="space-y-2">
          ...
          <DialogDescription className="text-center text-sm text-gray-700 sm:text-base">
            Escolha uma das opções a seguir para gerenciar suas matrículas
          </DialogDescription>
        </DialogHeader>
